...
>
> **IA v3 修订（2026-07-22）**：设备提升为一级导航 `/devices`（设备工作台，吸收
> §9.4 的 /scenarios/tailscale 总览页，后者退为跳转壳）；规则页真身迁至 `/rules`；
> 侧栏「扩展」组解散，链式代理收进「当前配置文件」组。§1.2 目标侧边栏、§1.3 的
> EXTENSIONS_NAV、§7.1 设备入口按此更新：DevicePanel 由 /devices 页取代，
